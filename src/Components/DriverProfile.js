...
function DriverProfile() {
    ...
    const [formData, setFormData] = useState({
        ...
        capabilities: {
            nashvilleParking: false,
            weatherUpdates: false,
            bikeRouteKnowledge: false
        }
    });
        ...
        <div style={sharedStyles.pageContainer}>
            ...
            >
                <form onSubmit={handleSubmit} className="driver-form">
                    ...
                    <div className="form-group">
                        <label>Nashville Transit Knowledge:</label>
                        <div className="checkbox-group">
                            {[
                                { 
                                    id: 'nashvilleParking', 
                                    label: 'Familiar with Nashville parking zones and public lots' 
                                },
                                { 
                                    id: 'weatherUpdates', 
                                    label: 'Can provide real-time weather updates and alternate routes' 
                                },
                                { 
                                    id: 'bikeRouteKnowledge', 
                                    label: 'Knowledge of Nashville bike-friendly routes and low-traffic areas' 
                                }
                            ].map(option => (
                                <div key={option.id} className="checkbox-item">
                                    <input
                                        ...
                                        id={option.id}
                                        name={option.id}
                                        checked={formData.capabilities[option.id]}
                                        onChange={handleInputChange}
                                    />
                                    <label htmlFor={option.id}>{option.label}</label>
                                </div>
