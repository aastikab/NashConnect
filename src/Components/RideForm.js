...
import { FaMapMarkerAlt, FaClock, FaUsers, FaAccessibleIcon, FaMoneyBillWave } from 'react-icons/fa';
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="preferences-section">
            <label>
              <input
                type="checkbox"
                checked={formData.needsAccessible}
                onChange={(e) => setFormData(prev => ({
                  ...prev,
                  needsAccessible: e.target.checked
                }))}
              />
              <FaAccessibleIcon /> Need Accessible Vehicle
            </label>
            ...
            <label>
              ...
              />
              <FaMoneyBillWave /> Apply Low-Income Discount
            </label>
          </div>
