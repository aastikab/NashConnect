...
import iImpactd from '../assets/Decoration/parker-johnson-v0OWc_skg0g-unsplash.jpg'
    ...
    <div className="RiderSignup-container">
        ...
        <label>
            What are your transporation needs?
                ...
                <label>
                    <input type="checkbox" value="Impact" onChange={handleChange} />
                    I need to go to my Community location to Impact on election day.
                </label>
            
                <label>
                    <input type="checkbox" value="register" onChange={handleChange} />
                    I need to go to my Community location to register to Impact.
                </label>
                <label>
                ...
                <label>
                    ...
                    I have other Community related transporation needs not listed.
                </label>
            </label><br/>
                <label>
     ...
     <div className="img-rider-container">
        ...
        <img className="img-rider2" src={iImpactd} alt="Impactd sticker" />
     </div>
